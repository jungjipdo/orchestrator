...
const DEFAULT_EDITOR_MODELS: Record<EditorType, AIModel[]> = {
    cursor: ['claude_sonnet_4_6', 'claude_opus_4_6', 'gpt_5_3_codex', 'gemini_3_pro', 'gemini_3_flash'],
    claude_code: ['claude_sonnet_4_6', 'claude_opus_4_6'],
    codex: ['gpt_5_3_codex', 'gpt_5_3_codex_spark'],
    antigravity: ['gemini_3_pro', 'gemini_3_flash', 'gemini_3_deep_think'],
    vscode: ['claude_sonnet_4_6', 'claude_opus_4_6', 'gpt_5_3_codex', 'gemini_3_pro'],
    terminal: ['claude_sonnet_4_6', 'claude_opus_4_6', 'gpt_5_3_codex', 'gpt_5_3_codex_spark', 'gemini_3_pro', 'gemini_3_flash', 'gemini_3_deep_think'],
    windsurf: [],
    zed: [],
}
